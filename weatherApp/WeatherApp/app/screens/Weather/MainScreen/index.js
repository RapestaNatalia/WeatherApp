...
import {Container,ImageWeather,ButtonContainer,ForestContainer} from './styled';
           ...
           && (
            ...
            source={
              weatherReducer.currentWeather[selectedId].icon
                ? Images.weather[weatherReducer.currentWeather[selectedId].icon].background
                : null
            }>
             <ButtonContainer>
              <Icon name={IconNames.Search} size ={36} color={theme.colors.black} onPress={searchLocation}> </Icon></ButtonContainer>
                <CurrentWeather
                iconName={
                    weatherReducer.currentWeather[selectedId].icon
                    ? Images.weather[weatherReducer.currentWeather[selectedId].icon].iconName
                    : null
                }
                ...
                typeWeather={weatherReducer.currentWeather[selectedId].description}
                city={weatherReducer.currentWeather[selectedId].city?weatherReducer.currentWeather[selectedId].city:null}
                />
            </ImageWeather>
